...
public abstract class SharedBiomeSystem : EntitySystem
{
    ...
    // Goob - Cache Noise
    // Concurrent porque o GetNoise e chamado de dentro do Parallel.ForEach do
    // BuildMarkerChunks. Com Dictionary comum duas threads corrompiam o cache, e ai
    // o BiomeSystem.Update morria antes de limpar o _activeChunks e passava a estourar
    // em todo tick pro resto da rodada.
